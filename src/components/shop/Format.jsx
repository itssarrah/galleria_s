...
function Format({ type, formData, setFormData }) {
  ...
  return (
    <div className={`${type == "false" ? "hidden" : "flex"} flex-col gap-3`}>
      ...
      <div className="flex flex-row gap-[8px]">
        <input
          ...
          checked={formData.selectedFormat === "Small business"}
        />
        <label>
      ...
      <div className="flex flex-row gap-[8px] mt-2">
        <input
          ...
          onChange={handleFormatChange}
          checked={formData.selectedFormat === "items/products"}
        />
        <label>
          <span className="text-black text-opacity-[70%] font-sunflower text-[18px] text-left">
            Items / Products
